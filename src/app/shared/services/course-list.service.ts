...
export class CourseListService {
  ...
  courseList: ICourse[] = [
    new Course(1, "Webpack", new Date(2020, 0, 20), 77, "Entries and outputs; Multiple budles; Loaders; Plugins; Production configuration.", true),
    ...
    new Course(4, "Components", new Date(2020, 0, 27), 77, "Entries and outputs; Multiple budles; Loaders; Plugins; Production configuration.", true),
    ...
    new Course(7, "Custom component", new Date(2001, 0, 5), 77, "Entries and outputs; Multiple budles; Loaders; Plugins; Production configuration.", true)
  ]
